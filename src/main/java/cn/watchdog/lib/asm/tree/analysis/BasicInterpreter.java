...
import cn.watchdog.lib.asm.tree.FieldInsnNode;
import cn.watchdog.lib.asm.tree.IntInsnNode;
import cn.watchdog.lib.asm.tree.InvokeDynamicInsnNode;
import cn.watchdog.lib.asm.tree.LdcInsnNode;
import cn.watchdog.lib.asm.tree.MethodInsnNode;
import cn.watchdog.lib.asm.tree.MultiANewArrayInsnNode;
...
public class BasicInterpreter extends Interpreter<BasicValue> implements Opcodes {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.analysis.BasicInterpreter} for the latest ASM API version. <i>Subclasses must
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.analysis.BasicInterpreter}.
	 *
