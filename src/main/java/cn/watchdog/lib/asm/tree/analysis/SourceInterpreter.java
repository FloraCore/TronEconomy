...
public class SourceInterpreter extends Interpreter<SourceValue> implements Opcodes {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.analysis.SourceInterpreter} for the latest ASM API version. <i>Subclasses must
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.analysis.SourceInterpreter}.
	 *
