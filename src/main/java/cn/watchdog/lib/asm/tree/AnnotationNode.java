...
public class AnnotationNode extends AnnotationVisitor {
	 ...
	 * array (for enumeration values), an {@link cn.watchdog.lib.asm.tree.AnnotationNode}, or a {@link java.util.List} of values of one
	 * of the preceding types. The list may be {@literal null} if there is no name value pair.
	 */
	public List<Object> values;

	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.AnnotationNode}. <i>Subclasses must not use this constructor</i>.
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.AnnotationNode}.
	 *
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.AnnotationNode} to visit an array value.
	 *
