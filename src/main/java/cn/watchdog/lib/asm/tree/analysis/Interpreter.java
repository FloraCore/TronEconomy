...
public abstract class Interpreter<V extends Value> {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.tree.analysis.Interpreter}.
	 *
	 ...
	 * cn.watchdog.lib.asm.tree.analysis.Interpreter#newReturnTypeValue(Type)}, {@link cn.watchdog.lib.asm.tree.analysis.Interpreter#newParameterValue(boolean, int,
	 * Type)}, {@link cn.watchdog.lib.asm.tree.analysis.Interpreter#newEmptyValue(int)}, {@link
	 * cn.watchdog.lib.asm.tree.analysis.Interpreter#newExceptionValue(TryCatchBlockNode, Frame, Type)} to distinguish different types
	 * of new value.
	 *
