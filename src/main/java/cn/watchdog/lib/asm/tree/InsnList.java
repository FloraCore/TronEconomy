...
public class InsnList implements Iterable<AbstractInsnNode> {
	 ...
	 * @param newInsnNode another instruction, <i>which must not belong to any {@link cn.watchdog.lib.asm.tree.InsnList}</i>.
	 */
	 ...
	 *
	 * @param insnNode an instruction, <i>which must not belong to any {@link cn.watchdog.lib.asm.tree.InsnList}</i>.
	 */
	 ...
	 *                     cn.watchdog.lib.asm.tree.InsnList}</i>.
	 */
	 ...
	 *
	 * @param mark if the instructions must be marked as no longer belonging to any {@link cn.watchdog.lib.asm.tree.InsnList}.
	 */
