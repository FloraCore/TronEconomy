...
public class ClassWriter extends ClassVisitor {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.ClassWriter} object.
	 *
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.ClassWriter} object and enables optimizations for "mostly add" bytecode
	 ...
	 *       from a {@link cn.watchdog.lib.asm.ClassWriter} (and not from any other {@link ClassVisitor} instance).
	 * </ul>
	 *
	 ...
	 * #getCommonSuperClass(String, String)}, that of this {@link cn.watchdog.lib.asm.ClassWriter}'s runtime type by
	 * default.
	 *
	 * @return ClassLoader
	 */
