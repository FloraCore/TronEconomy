...
import cn.watchdog.lib.asm.TypeReference;
import cn.watchdog.lib.asm.tree.MethodNode;
import cn.watchdog.lib.asm.tree.analysis.Analyzer;
import cn.watchdog.lib.asm.tree.analysis.AnalyzerException;
import cn.watchdog.lib.asm.tree.analysis.BasicValue;
import cn.watchdog.lib.asm.tree.analysis.BasicVerifier;
 ...
 * #CheckMethodAdapter(int, String, String, MethodVisitor, java.util.Map)} constructor. They are not performed if
...
public class CheckMethodAdapter extends MethodVisitor {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.util.CheckMethodAdapter} object. This method adapter will perform basic data
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.util.CheckMethodAdapter} object. This method adapter will not perform any
	 * data flow check (see {@link #CheckMethodAdapter(int, String, String, MethodVisitor, java.util.Map)}).
	 * <i>Subclasses must not use this constructor</i>. Instead, they must use the {@link
	 * #CheckMethodAdapter(int, MethodVisitor, java.util.Map)} version.
	 *
	 * @param methodvisitor the method visitor to which this adapter must delegate calls.
	 */
	 ...
	 * #CheckMethodAdapter(int, int, String, String, MethodVisitor, java.util.Map)} version.
	 *
	 * @param access           the method's access flags.
	 * @param name             the method's name.
	 * @param descriptor       the method's descriptor (see {@link Type}).
