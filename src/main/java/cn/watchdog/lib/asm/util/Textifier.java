...
import cn.watchdog.lib.asm.signature.SignatureReader;
...
public class Textifier extends Printer {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.util.Textifier}. <i>Subclasses must not use this constructor</i>. Instead,
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.util.Textifier}.
	 *
	 ...
	 * @throws java.io.IOException if the class cannot be found, or if an IOException occurs.
	 */
	...
	/**
	 * Creates and adds to {@link #text} a new {@link cn.watchdog.lib.asm.util.Textifier}, followed by the given string.
	 *
	 * @param endText the text to add to {@link #text} after the textifier. May be {@literal null}.
	 * @return the newly created {@link cn.watchdog.lib.asm.util.Textifier}.
	 */
	...
	/**
	 * Creates a new {@link cn.watchdog.lib.asm.util.Textifier}.
	 *
	 * @return a new {@link cn.watchdog.lib.asm.util.Textifier}.
	 */
