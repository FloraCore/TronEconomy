...
public class CheckModuleAdapter extends ModuleVisitor {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.util.CheckModuleAdapter}. <i>Subclasses must not use this constructor</i>.
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.util.CheckModuleAdapter}.
	 *
