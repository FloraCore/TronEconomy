...
class Frame {
	 ...
	 *
	 * @param symbolTable  the type table to use to lookup and store type {@link Symbol}.
	 * @param abstractType an abstract type, restricted to {@link cn.watchdog.lib.asm.Frame#CONSTANT_KIND}, {@link
	 *                     cn.watchdog.lib.asm.Frame#REFERENCE_KIND} or {@link cn.watchdog.lib.asm.Frame#UNINITIALIZED_KIND} types.
	...
	/**
	 * Merges the input frame of the given {@link cn.watchdog.lib.asm.Frame} with the input and output frames of this
	 * {@link cn.watchdog.lib.asm.Frame}. Returns {@literal true} if the given frame has been changed by this operation
	 * (the input and output frames of this {@link cn.watchdog.lib.asm.Frame} are never changed).
	 *
	 * @param symbolTable    the type table to use to lookup and store type {@link Symbol}.
	 * @param dstFrame       the {@link cn.watchdog.lib.asm.Frame} whose input frame must be updated. This should be the frame
	...
	/**
	 * Makes the given {@link MethodWriter} visit the input frame of this {@link cn.watchdog.lib.asm.Frame}. The visit is
