...
final class AnnotationWriter extends AnnotationVisitor {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.AnnotationWriter}.
	 *
	...
	/**
	 * Creates a new {@link cn.watchdog.lib.asm.AnnotationWriter} using named values.
	 *
	 * @param symbolTable        where the constants used in this AnnotationWriter must be stored.
	 ...
	 *                           Runtime[In]Visible[Type]Annotations attribute to which this annotation belongs, or
	 *                           {@literal null} in other cases (e.g. nested or array annotations).
	 * @return a new {@link cn.watchdog.lib.asm.AnnotationWriter} for the given annotation descriptor.
	 */
	 ...
	 *                           Runtime[In]Visible[Type]Annotations attribute to which this annotation belongs, or
	 *                           {@literal null} in other cases (e.g. nested or array annotations).
	 * @return a new {@link cn.watchdog.lib.asm.AnnotationWriter} for the given type annotation reference and descriptor.
	 */
	static AnnotationWriter create(
			final SymbolTable symbolTable,
			final int typeRef,
