...
public class ByteVector {
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.ByteVector} with a default initial capacity.
	 */
	public ByteVector() {
		data = new byte[64];
	}
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.ByteVector} with the given initial capacity.
	 *
	...
	/**
	 * Constructs a new {@link cn.watchdog.lib.asm.ByteVector} from the given initial data.
	 *
