...
/**
 * A task that copies {@link java.util.jar.JarEntry jar entries} from a {@link java.util.jar.JarFile jar input} to a
 * {@link java.util.jar.JarOutputStream jar output}, applying the relocations defined by a
